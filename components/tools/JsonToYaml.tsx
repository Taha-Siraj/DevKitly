...
export default function JsonToYaml() {
  ...
  const handleConvert = () => {
    ...
    try {
      ...
      setOutput(yamlStr);
      setError(null);
      toast("Successfully converted to YAML!");
    } catch (e: any) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col space-y-2">
          <div className="flex justify-between items-center h-5">
            <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">YAML Output</span>
            {output && (
